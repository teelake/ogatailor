...
CREATE TABLE IF NOT EXISTS plan_settings (
    ...
    invoices_per_month INT NULL,
    created_at DATETIME NOT NULL,
    updated_at DATETIME NOT NULL
);

INSERT INTO plan_settings (plan_code, customer_limit, can_sync, can_export, can_multi_device, can_advanced_reminders, invoices_per_month, created_at, updated_at)
VALUES
  ('starter', 50, 0, 0, 0, 0, 25, NOW(), NOW()),
  ('growth', 500, 1, 1, 0, 1, 100, NOW(), NOW()),
  ('pro', NULL, 1, 1, 1, 1, 500, NOW(), NOW())
ON DUPLICATE KEY UPDATE
  ...
  invoices_per_month = VALUES(invoices_per_month),
