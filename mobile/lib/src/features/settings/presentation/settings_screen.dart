          ...
          _SettingsSection(
            ...
            children: [
              _SettingsTile(
                ...
                title: 'Upgrade Plan',
                subtitle: planSummaryAsync.valueOrNull?.isFree == false
                    ? 'Paid plan active'
                    : 'Unlock cloud backup & unlimited customers',
                trailing: planSummaryAsync.valueOrNull?.isFree == false
                    ? const _PlanBadge(label: 'Paid')
                    : null,
                onTap: () => Navigator.of(context).push(
