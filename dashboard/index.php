...
<div class="dashboard-hero">
    <div class="hero-stats">
        <div class="hero-stat">
            <span class="hero-value"><?= number_format($userCountAll) ?></span>
            <span class="hero-label">Total tailors</span>
        </div>
        <div class="hero-stat">
            <span class="hero-value"><?= number_format($customerCountAll) ?></span>
            <span class="hero-label">Total customers</span>
        </div>
        <div class="hero-stat">
            <span class="hero-value"><?= number_format($orderCountAll) ?></span>
            <span class="hero-label">Total orders</span>
        </div>
        <div class="hero-stat">
            <span class="hero-value">₦<?= number_format($revenueAll, 0) ?></span>
